...
pub struct Block {
    header: Blockheader,
    count: u32,
    transactions: Vec<Tranaction>
}

pub struct Chain{
    chain: Vec<Block>,
    curr_transaction: Vec<Tranaction>,
    difficulty: u32,
    miner_addr: String,
    reward:f32,
} 
...
impl Chain {
    ...
    pub fn new_transaction(&mut self, sender: String, receiver: String, amount:f32 ) -> bool {
        self.curr_transaction.push(Tranaction{
    ...
    fn get_merkle(curr_transaction: Vec<Tranaction>) -> String {
